    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Jadwal Kegiatan Kantor Camat Air Batu</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Jadwal Kegiatan</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nomor Kegiatan</th><th width="30%">Nama Kegiatan</th><th>Tanggal</th><th>Pelaksana</th><th>Lokasi</th><th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
