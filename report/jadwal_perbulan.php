...
<html>
    <head>
        <title>Cetak Data Jadwal Kegiatan Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA JADWAL KEGIATAN BULAN <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM jadwal WHERE substr(tanggal,1,7)='$ambilthn-$ambilbln'";
